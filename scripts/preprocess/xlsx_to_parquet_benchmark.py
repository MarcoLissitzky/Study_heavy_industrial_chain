...
DEFAULT_PARQUET_RAW_DIR = PROJECT_ROOT / "data" / "raw" / "registry_cn_parquet"
...
def main() -> int:
    ...
    p.add_argument("--out-dir", default=str(DEFAULT_PARQUET_RAW_DIR), help=f"Output parquet root (default: {DEFAULT_PARQUET_RAW_DIR})")
